...
for current_seed in range(args.train_seed,(args.train_seed + 50)):
    ...
    path_save = "./outputs_para/rd_%d_%d_%d_%.3f_%.3f_%d_%d.npy"%(train_curve_num,test_curve_num,
                                                                    sample_size,noise_sigma,D,num_grid,seed_train)

    path_checkpoint = "./checkpoint_para/ckpt_rd_%d_%d_%d_%.3f_%.3f_%d_%d.pth"%(train_curve_num,test_curve_num,
                                                                    sample_size,noise_sigma,D,num_grid,seed_train)
