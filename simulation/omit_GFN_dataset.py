            ...
            for j in range(self.sample_size+1):
                if j == 0:
                    ...
                    state = self.pde_model.solve(
                        state,t_range=[0,self.observed_delta_t],dt = self.delta_t)
...
def create_data(path_train = ".\data\train", path_test = ".\data\test", D_1=1e-3, D_2=5e-3, func_f=None, func_g=None, a=0.1, epsilon=1, gamma=1, bc=None, batch_size=64, train_curve_num=100, test_curve_num=10, sample_size=100, T_range=None, delta_t=1e-3, range_grid=None, period=None, num_grid=None, seed_train=None, seed_test=20221106, initial=None, noise_sigma=0.1, dim=2):
